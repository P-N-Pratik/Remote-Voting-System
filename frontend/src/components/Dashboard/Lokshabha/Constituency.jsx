...
import Addconstituency from '../../Addbuttons/Addconstituency';
...
const Constituency=()=> {
  ...
  return (
    <div className='flex flex-col px-4 gap-4 justify-end'>
      <h1 className='font-mono text-2xl font-semibold '>Add Constituency</h1>
      ...
      {showPopup && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center ">
          <Addconstituency onClose={handleClosePopup} />
        </div>
      )}
